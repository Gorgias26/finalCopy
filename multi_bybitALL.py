...
import ccxt
import time
sys.path.append("./Live-Tools-V2-bybit-Java1")

import asyncio
from utilities.bytbit_perp import PerpBybit
from secret import ACCOUNTS1
import ta
import numpy as np
        ...
        try:
            ...
            try:
                ...
                for position in positions:
                    ...
                    tasks_close.append(
                        exchange.place_order(   # avait enlevais
                            pair=position.pair,
                    ...
                    if position.side == "long":
                        ...
                        sl_price = exchange.price_to_precision(position.pair, position.entry_price * (1 + sl))
                    tasks_close.append(
                        exchange.place_trigger_order(  # avait enlevais peut etre a remetre.
                            pair=position.pair,
                            side=sl_side,
                    ...
                    for i in range(
                        ...
                        tasks_open.append(
                            await exchange.place_trigger_order(   # avait enlevais peut etre a remetre.
                                pair=position.pair,
                                side="buy",
            ...
            print(f"Problème de connexion 6 : {e}")
